...
class SyntheticInstance:
    """Synthetic instance generated by StyleGAN3 for training augmentation."""
    synthetic_id: str
    source_bag_id: str  # Bag this was generated for
    image_path: str
    label_name: str  # Always "ADM" for this project
    seed: int  # Random seed used for generation
    truncation_psi: float
    is_filtered: bool  # Whether passed nearest-neighbor filter
    similarity_score: float | None  # Similarity to nearest real instance
    feature_path: str | None = None  # Path to cached UNI features
